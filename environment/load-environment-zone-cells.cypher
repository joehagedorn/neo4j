// ============================================================================
// Stage B — Create IntraZone anchors for Environmental Monitoring Sites (res-14)
//
// Each monitoring site was mapped to a single res-14 H3 cell (~6.3 m²) via
// its lat/lng coordinate. This creates an IntraZone node, links it to the
// Zone via ANCHORS, and links it to the parent res-8 ZoneCell via WITHIN_CELL
// (when that backbone cell exists) for Moku traversal.
//
// This completes the SDG spatial bridge:
...
//   - Environment Zone nodes created (Stage A)
// ============================================================================
