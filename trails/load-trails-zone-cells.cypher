// ============================================================================
// Stage B — Link Trail Zones to res-8 ZoneCells via IN_ZONE
//
// Each trail feature was mapped to a single res-8 H3 cell via midpoint.
...
//   - Trail Zone nodes created (Stage A)
// ============================================================================

LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/joehagedorn/neo4j/main/trails/TRL_Zones_H3.csv' AS row
