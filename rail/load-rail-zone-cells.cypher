// ============================================================================
// Stage B — Create res-10 ZoneCells for HART Rail and link to Zones + Moku
//
// Creates new ZoneCell nodes at resolution 10 (~3.7 acres/cell) tracing
// the rail guideway corridor. Links them to transit Zone nodes via IN_ZONE
// and attaches them to Moku nodes via WITHIN.
//
// Prerequisites:
//   - Rail Zone nodes created via Stage A
//   - Moku nodes must exist with an `id` property
// ============================================================================

LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/joehagedorn/neo4j/main/rail/RAIL_Zones_H3.csv' AS row
