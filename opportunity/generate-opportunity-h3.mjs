/**
 * Generate centroid-based H3 resolution-8 mapping for Hawaii Opportunity Zones
 *
 * Each of the 25 opportunity zone features is mapped to a single res-8 H3
...
for (const feature of geojson.features) {
  ...
  const provenance = `Centroid res8 from OZ tract ${props.tract_no} (${tractName}) polygon`;

  rows.push(`${zoneId},${h3Cell},8,${VERSION},OZ centroid 2026,${provenance}`);
