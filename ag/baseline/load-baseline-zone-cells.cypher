// ============================================================================
// Stage B — Link Baseline Zones to res-7 ZoneCells via IN_ZONE
//
// Each baseline feature was mapped to a single res-7 H3 cell via centroid.
...
//   - Baseline Zone nodes created (Stage A)
// ============================================================================

LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/joehagedorn/neo4j/main/ag/baseline/ALU_Zones_H3.csv' AS row
...
// 2) Attach to existing res-7 ZoneCell (no :ALU label — backbone cells only)
WITH z, h3
