// ============================================================================
// Stage B — Link Baseline Zones to res-8 ZoneCells via IN_ZONE
//
// Each baseline feature was mapped to a single res-8 H3 cell via centroid.
...
// 2) Attach to existing res-8 ZoneCell (no :ALU label — backbone cells only)
WITH z, h3
