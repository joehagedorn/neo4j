// ============================================================================
// Stage B — Create IntraZone anchors for School Zones (res-14)
//
...
//   - School Zone nodes created (Stage A)
// ============================================================================

LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/joehagedorn/neo4j/main/schools/SCH_IntraZones_H3.csv' AS row
